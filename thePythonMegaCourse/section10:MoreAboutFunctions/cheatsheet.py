...
"""
def cuboid_volume (a, b, c=10): # "a and b" = non-default params, "c=10" = default parameter
  return a * b * c

print(cuboid_volume(2, b=3)) # "2" = non-keyword (positional) argument, "b=3" keyword argument